...
Nous voici avec 2 semaines d'actualités React. Il y a pas mal de bons articles React, et aussi quelques annonces très intéressantes sur React-Native liées aux conférences qui ont eu lieu récemment. Entre Remix Conf, App.js, Chain React... il est difficile de tout suivre, sans parler de React-Native-Connection et React Summit la semaine prochaine !

Les bibliothèques de récupération de données comme React-Query et Apollo s'interrogent sur leur intégration avec les Server Components et le routeur d'applications de Next.js. On commence à y voir plus clair.
...
**[Start UI [web] - Démarreur d'interface d'application web avec des choix d'architecture prédéfinis](https://web.start-ui.com?utm_source=newsletter&utm_term=this-week-in-react)**

Notre **démarreur d'interface d'application web gratuit et open source** offre un moyen rapide et facile d'amorcer votre prochain projet. Il inclut **les bonnes pratiques et des outils prêts pour la production** pour vous aider à démarrer immédiatement, vous faisant gagner du temps et des efforts dans la phase de configuration initiale.

Livré avec **des fonctionnalités intégrées** comme 🔐 Authentification, 📱 Mise en page adaptative, 🧑‍💻 Gestion des utilisateurs, 🇫🇷 Internationalisation et support de droite à gauche, 🌚 Mode sombre, 🎛 Composants avancés pour un développement facile. Vous pouvez essayer l'[application de démonstration](https://demo.start-ui.com).
...
[![Spotify - Navigation spatiale pour la télévision](/emails/issues/146/spotify.jpg)](https://engineering.atspotify.com/2023/05/tv-spatial-navigation/)

**[Spotify - Navigation spatiale pour la télévision](https://engineering.atspotify.com/2023/05/tv-spatial-navigation/)**

Spotify explique comment ils développent leurs applications pour la télévision et les consoles en s'appuyant sur une technologie hybride (web). Il n'existe pas de navigation spatiale (flèches/joystick) sur le web, et ils ont créé leur propre navigation spatiale en utilisant des composants React.
...
**[En direct la semaine prochaine : Décrochez le poste de développeur de vos rêves](https://info.nylas.com/webinar-devtalent-registration.html?utm_source=twir&utm_medium=sponsoredemail&utm_campaign=FY23Q2-TLDR-2P&utm_content=2023-05-24-Issue-DevTalentWebinar)**

Que vous soyez un développeur expérimenté ou un récent diplômé de bootcamp, vous devez savoir ce que les employeurs recherchent chez les candidats ingénieurs aujourd'hui.

Rejoignez les responsables du recrutement technique de Nylas pour leurs conseils sur la réussite de votre prochain entretien.

Nous aborderons la gestion des questions d'entretien courantes, l'approche des sujets liés à l'IA générative et autres technologies émergentes, et bien plus encore.
...
[![Conférence sur RN Skia](/emails/issues/146/skia.jpg)](https://www.youtube.com/watch?v=Hfb_gpfCHzk)

**[La joie de peindre avec Skia](https://www.youtube.com/watch?v=Hfb_gpfCHzk)**

William Candillon présente lors d'App.js les avancées de React-Native Skia. L'intégration avec Reanimated s'améliore. Un composant RichText est en développement. Les exemples d'intégration avec les vues natives sont vraiment impressionnants.

---

[![Conférence sur Expo Router](/emails/issues/146/expo-router.jpg)](https://www.youtube.com/watch?v=608r8etX_cg)

**[Écrire une fois, router partout : navigation basée sur le système de fichiers pour les applications natives](https://www.youtube.com/watch?v=608r8etX_cg)**

Evan Bacon présente lors d'App.js les fonctionnalités prévues pour Expo Router v2. Voir aussi ce [fil](https://twitter.com/Baconbrix/status/1656634363847507968). L'utilisation de liens universels offre de nombreux avantages UX. Expo continue d'investir dans le support web, qui progresse bien grâce aux dernières avancées du bundler Metro. Un support CSS est même prévu. Expo pourrait-il commencer à concurrencer Next.js sur le web ?

---

- 📜 [Messenger Desktop : Plus rapide et plus léger en passant à React Native depuis Electron](https://developers.facebook.com/blog/post/2023/05/17/messenger-desktop-faster-and-smaller-by-moving-to-react-native-from-electron/) : Meta utilise désormais React-Native Windows/macOS sur Messenger, rapportant des gains de performance mais aussi des défis rencontrés. Comme pour le mobile, il est préférable d'avoir des développeurs compétents sur chaque plateforme native. La collaboration Meta/Microsoft devrait aider à pérenniser ces plateformes.
- 📦 [0.72.0-RC.3](https://github.com/facebook/react-native/releases/tag/v0.72.0-rc.3) : Release Candidate "Golden" qui devrait devenir la version finale 0.72 très prochainement.
- 👀 [Remotion + React-Native](https://twitter.com/JNYBGR/status/1657041691319336960) : prototype pour rendre des vidéos Remotion directement sur votre téléphone.
...
- 🧵 [Megathread de la conférence App.js](https://twitter.com/flexbox_/status/1657994812346499072)
- 🧵 [Annonces d'App.js](https://twitter.com/expo/status/1656802035373850625)
- 🎥 [Cedric van Putten – Le débogage devrait être plus simple | App.js Conf 2023](https://www.youtube.com/watch?v=sRLunWEzwHI)
- 🎥 [Est-ce l'avenir de React Native ? Récapitulatif et insights d'App.js](https://www.youtube.com/watch?v=8ou9dq5HKHk)
- 🎥 [Animation Metaball avec React Native Skia](https://www.youtube.com/watch?v=HOxZegqnDC4)
...
Souhaitez-vous travailler sur les applications les plus utilisées au monde ? Voulez-vous co-créer la technologie React Native ? Rejoignez l'équipe de leaders React & React Native chez Callstack. Consultez notre site pour plus de détails. Nous attendons votre candidature avec impatience - montrez-nous ce que vous savez faire !
...
- [Advancing Interaction to Next Paint](https://web.dev/inp-cwv/) : L'INP deviendra un Core Web Vitals et remplacera le FID (First Input Delay). Une métrique pertinente pour évaluer les applications React après le chargement initial de la page.
- [The Bun Bundler](https://bun.sh/blog/bun-bundler) : Bun dispose désormais d'un bundler. Résultats de benchmark : 2x plus rapide qu'esbuild, 200x plus rapide que Webpack !
