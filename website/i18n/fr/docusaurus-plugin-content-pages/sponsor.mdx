...
# Parrainer la newsletter

Atteignez un public **qualifié et engagé** de **développeurs React intermédiaires/seniors** avec une publicité dans notre [newsletter hebdomadaire](/newsletter).
...
- **développeurs React-Native** : une section dédiée dans la newsletter
- **expérimentés** : ils connaissent bien React et ne cherchent pas de contenu pour débutants
- **passionnés** : ils veulent rester à jour sur leur technologie préférée
- **ouverts d'esprit** : ils souhaitent aussi connaître l'actualité non-React qui les concerne
...
Notre audience est bien équilibrée, avec la plus grande part en **Europe** (40%) suivie par **Amérique du Nord** (18%).
...
Cet emplacement offre un espace généreux en début de newsletter, avant la section React.
...
Les Liens sponsorisés sont insérés dans les sections React ou React-Native de la newsletter, aux côtés du contenu régulier. **Les abonnés ne peuvent pas les manquer**, placés entre les titres de section et la liste des liens qui les intéressent.

Jusqu'à 2 liens sponsorisés par section. Lorsqu'il y a plus d'un lien sponsorisé, le 2ème apparaît au milieu de la section.
...
- promouvoir un **contenu pertinent** tel qu'un article de blog tutoriel sur un produit
...
- obtenir un **coût par clic inférieur** : privilégier le nombre de clics plutôt que la notoriété de la marque
- générer du trafic vers votre site pour créer des audiences de retargeting et de look-alike qualifiées

:::

### 🧑‍🎨 Personnalisé

Contactez [sponsor@thisweekinreact.com](mailto:sponsor@thisweekinreact.com?subject=Custom%20sponsorship%20offering) pour nous expliquer vos objectifs marketing. Nous pouvons créer des offres personnalisées incluant :

- des bundles de placement personnalisés avec des remises sur la quantité
- des placements sponsorisés en haut de l'e-mail sur nos [articles React](/articles) occasionnels
- des placements intelligents sponsorisés, étroitement intégrés dans un article que nous rédigeons en lien avec votre produit

---

## Processus de commande {#order-process}

La manière la plus simple est de simplement nous contacter, nous vous répondrons dès que possible en vous expliquant tout :

- envoyez un e-mail à [**sponsor@thisweekinreact.com**](mailto:sponsor@thisweekinreact.com?subject=Sponsorships)
- remplissez le [**formulaire de contact**](https://thisweekinreact.com/sponsor/form)

### ⏱ Maintenant {#now}

Alternativement, vous pouvez également nous fournir directement toutes les informations nécessaires et suivre ces étapes :

- sélectionnez votre [placement](#placements) et le nombre de numéros
- sélectionnez les dates disponibles sur le [calendrier public des sponsorships](https://thisweekinreact.com/calendar)
- préparez les détails de votre société pour la facturation
- envoyez-nous un e-mail à [sponsor@thisweekinreact.com](mailto:sponsor@thisweekinreact.com?subject=Sponsorship)
- accusez réception de notre facture

**Informations supplémentaires utiles à fournir** :

- indiquez-nous si vous avez des contraintes calendaires strictes, comme un événement à date fixe
- fournissez-nous une liste des entreprises à côté desquelles vous ne souhaitez pas apparaître dans le même numéro
...
- vous fournissez le contenu publicitaire au moins une semaine avant la date de publication
- nous examinons et validons le contenu publicitaire
- nous incluons l'annonce dans les newsletters 🎉

---

## Sponsorer ou pas ?

Assurez-vous que votre annonce est pertinente pour le public cible.

### ✅ Bonne adéquation

- Toucher les **développeurs React intermédiaires/seniors**
- Toucher les **enthousiastes multiplateformes**, utilisant à la fois **React et React-Native**
- Toucher les développeurs **ouverts d'esprit** utilisant JavaScript, TypeScript, Node.js...
- Toucher les **décideurs** : CTO, tech leads, responsables ingénierie...

### ❌ Mauvaise adéquation

- Toucher un public uniquement de développeurs React **juniors**
- Promouvoir quelque chose **d'irrelevant** pour les développeurs React

:::info

Nous vous dirons si nous pensons que votre annonce n'est pas adaptée.
