...
Après quelques semaines intenses, l'écosystème React ralentit légèrement en termes d'annonces majeures.

Nous avons tout de même de très bons articles qui sortent. Le plugin TypeScript pour Next.js semble formidable !

La conférence GitHub Universe s'est terminée. GitHub semble utiliser React de plus en plus, sur certaines vues, et également via les GitHub Blocks basés sur MDX.
...
[FlyCode](https://bit.ly/3wWSi00) (YC S22) rend les applications web React modifiables en quelques minutes afin que les équipes Produit et UX puissent itérer et publier des produits plus rapidement, sans attendre (ou consommer) le temps des développeurs.

FlyCode lit votre code React standard et identifie les textes, images, jetons de conception et événements d'analyse, puis permet aux non-développeurs de collaborer pour les modifier et soumettre une pull request (sans nécessiter d'accès GitHub !).
...
- Utilisez votre propre pile et composants
...
[![Dans les coulisses de Magic Motion de Framer](/emails/issues/124/framer-motion.png)](https://www.nan.fyi/magic-motion)

**[Dans les coulisses de Magic Motion de Framer](https://www.nan.fyi/magic-motion)**

Un excellent article interactif expliquant ce qu'est une animation de mise en page. Il déconstruit magistralement la technique FLIP qui améliore les performances de ce type de transition via les transformations CSS (position, échelle). Nous recréons pas à pas le système d'animation de mise en page de Framer Motion.

Sur le même sujet, je recommande également la lecture de [Tout sur les animations de mise en page avec Framer Motion](https://blog.maximeheckel.com/posts/framer-motion-layout-animations/).

---

[![Chronologie d'un composant React avec Hooks](/emails/issues/124/timeline.jpg)](https://julesblom.com/writing/react-hook-component-timeline)

**[Chronologie d'un composant React avec Hooks](https://julesblom.com/writing/react-hook-component-timeline)**

Un diagramme interactif démontrant le cycle de vie d'un composant React, incluant hooks, refs et mises à jour/rendu DOM (non disponible sur mobile). Comprend également un quiz pour tester vos connaissances et de nombreuses citations/références.
...
Shu Ding travaille sur un plugin de service de langage TypeScript ([source](https://github.com/vercel/next.js/blob/canary/packages/next/server/next-typescript.ts)) qui améliore significativement l'expérience développeur (DX) de Next.js en apportant de la documentation, de nouvelles erreurs et de l'auto-complétion basées sur les conventions de Next.js et des Server Components. Cela compense agréablement l'[incapacité à typer les exports d'un module ES](https://github.com/microsoft/TypeScript/issues/38511) dans TypeScript, une fonctionnalité très demandée par les auteurs de frameworks.

---

[![Écrire du CSS performant avec vanilla-extract](/emails/issues/124/vanilla-extract.png)](https://www.lekoarts.de/javascript/writing-performant-css-with-vanilla-extract)
...
[![refine - 100% open-source, framework React headless pour construire des applications CRUD](/emails/issues/124/refine.jpg)](https://s.refine.dev/github)

**[refine - 100% open-source, framework React headless pour construire des applications CRUD](https://s.refine.dev/github)**

refine fonctionne de manière transparente avec n'importe quel design personnalisé ou framework d'interface que vous préférez. Pour plus de commodité, il est livré avec des intégrations prêtes à l'emploi pour Ant Design, Material UI, Mantine et Chakra UI. Il élimine les tâches répétitives exigées par les opérations CRUD et fournit des solutions standardisées pour des parties critiques comme l'authentification, le contrôle d'accès, le routage, le réseau, la gestion d'état et l'i18n.

---

## 📱 React-Native {#react-native}

- 📜 [Expo-router et code distant](https://medium.com/@dan_tamas/expo-router-and-remote-code-e49f31a33b73) : montre comment utiliser [react-native-wormhole](https://github.com/cawfree/react-native-wormhole) avec Expo Router pour consommer des composants React-Native depuis une URL distante. C'est assez lié à l'idée d'avoir des [React-Native Server Components](https://twitter.com/Baconbrix/status/1585058874864062466).
- 🧵 [Thread sur l'API Expo Modules](https://twitter.com/tsapeta/status/1590353202402115584) : Tomasz Sapeta partage des informations intéressantes sur la nouvelle API d'Expo pour créer des modules natifs modernes en Swift/Kotlin, incluant des développements futurs comme le support de [SwiftUI](https://twitter.com/tsapeta/status/1591003968649728001) / Jetpack Compose.
...
[![Mème - URGENT : JavaScript a été banni de Twitter pour avoir imité un vrai langage de programmation.](/emails/issues/124/meme.png)](https://twitter.com/lukaseder/status/1590301562525876225)