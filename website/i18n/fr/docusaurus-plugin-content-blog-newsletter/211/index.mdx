...
C'est une autre excellente semaine pour React avec des sorties passionnantes, notamment React Router 7 et Vite 6. TanStack a failli voler la vedette !

L'écosystème React Native n'est pas en reste avec la version 0.77 en RC, Legend List, Screens... et une innovation plutôt excitante basée sur Wasm.
...
**[AG Charts : Les meilleurs graphiques React au monde.](https://www.ag-grid.com/charts?utm_source=thisweekinreact&utm_medium=newsletter&utm_campaign=2024-email-4)**

AG Charts est une bibliothèque de graphiques basée sur canvas d'AG Grid. Initialement conçue pour alimenter les [Graphiques Intégrés d'AG Grid](https://www.ag-grid.com/react-table?utm_source=thisweekinreact&utm_medium=newsletter&utm_campaign=2024-email-4), AG Charts dépasse désormais **1 million** de téléchargements npm/mois :

- 🆓 **Gratuit :** Accédez à une gamme de types de graphiques, dont les **barres**, **lignes**, **nuages de points**, **aires**, et plus encore – complètement **gratuits**, pour toujours.
- 🚀 **Rapide :** Grâce au **rendu par lots** et à la détection avancée des changements couplés à l'**API Canvas hors écran**, AG Charts peut facilement afficher des centaines de milliers de points de données prêts à l'emploi.
...
- 🏢 **Fonctionnalités Entreprise :** Passez à Enterprise pour débloquer des capacités avancées telles que les animations, menus contextuels, réticules et plus. Essayez-le gratuitement, sans licence d'essai requise.
...
Comme prévu, les fonctionnalités de Remix ont été intégrées à React Router, et les caractéristiques du framework full-stack sont désormais alimentées par un plugin Vite. Il y a également de nouvelles fonctionnalités liées au routage, à la sécurité des types et au pré-rendu des routes. Les utilisateurs de Remix v2 sont invités à passer à React Router v7 : cela devrait être facile après avoir activé les indicateurs futurs. Maintenant que cette grande étape est terminée et que l'équipe peut se concentrer pleinement sur la prochaine vague d'innovation, nous avons hâte d'entendre le prochain Michael Jackson Remix.
...
[![Libérez des superpouvoirs documentaires dans vos applications React !](/emails/issues/209/nutrient.jpg)](https://www.nutrient.io/sdk/web)

**[Libérez des superpouvoirs documentaires dans vos applications React !](https://www.nutrient.io/sdk/web)**

À l'attention des passionnés de React : PSPDFKit s'appelle désormais **Nutrient** ! 👋 Nous avons peut-être un nouveau nom, mais notre SDK Web reste le choix de référence que vous connaissez pour visualiser, annoter et modifier des PDF et autres types de documents.
...
La bibliothèque utilisée par React Navigation et Expo Router a été publiée il y a quelques semaines, et le billet de blog promis est enfin en ligne, présentant les points forts visuellement via diverses vidéos :

- API Sheets : `formSheet` Android et détentes personnalisées iOS
- Pré-chargement des écrans pour la pile native afin d'améliorer les performances perçues
...
- 📣 [Deno v. Oracle : Annulation de la marque JavaScript](https://deno.com/blog/deno-v-oracle)
- 📜 [Un cadre pour l'évaluation du support navigateur](https://www.joshwcomeau.com/css/browser-support/)
...
- 📦 [TypeScript 5.7 - Types lib 2024, vérification des variables non initialisées, réécriture d'extensions, démarrage plus rapide](https://devblogs.microsoft.com/typescript/announcing-typescript-5-7/)
- 📦 [Mock Service Worker - Support WebSockets](https://mswjs.io/blog/enter-websockets/)
